    ...
    <section id="contact" className="flex flex-col items-center p-8 bg-gradient-to-b from-blue-50 to-gray-200 text-gray-800">
      <div className="bg-white rounded-lg p-6 text-center shadow-md w-full max-w-md">
        ...
        <div className="flex flex-col items-center space-y-4">
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/julia-natera-chavez-917b62172" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 transition-transform duration-300 hover:scale-105">
